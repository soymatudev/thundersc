...
const gridOptions = {
      ...
      pagination: true,
      paginationAutoPageSize: true, // Permite elegir de cuanto en cuanto si  es false

      defaultColDef: {
        sortable: true, // Hacer todas las columnas ordenables por defecto
        filter: true, // Habilitar filtros por defecto
        editable: false,
