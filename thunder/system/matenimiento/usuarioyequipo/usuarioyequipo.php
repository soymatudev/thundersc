...
<body>
      ...
      <div class="box-form bordes_redondeados shadow select-area" id="select-area">
        ...
        <div class="container-c-g">
          ...
          <div id="divArea">
            ...
            <input type="text" class="form_input bordes_redondeados input-area" name="nombre" id="area" />
          </div>

          <div id="divTelefono">
            <p class="label-c-g">Telefono:</p>
            <input type="tel" class="form_input bordes_redondeados input-area" name="telefono" id="telefono" />
          </div>

          <div id="divEquiTrabajo">
            <p class="label-c-g">Equipos de Trabajo:</p>
            <select class="select col-md-2" name="states[]" tabindex="-1" aria-hidden="true" id="comboEquiposT">
            </select>
          </div>

          <div id="divPassword">
            <p class="label-c-g">Constrasena:</p>
            <input type="password" maxlength="10" class="form_input bordes_redondeados input-area" name="password" id="password" />
          </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="container-zone">
                    <div class="work-zone d-flex">
                      <div class="container-grid">
                        <div class="grid ag-theme-quartz-dark" id="container-tablaTwo" style="height: 85vh">
                          <!-- Aqui se genera un grid -->
                        </div>
                      </div>
                    </div>
  ...
  <script defer src="./usuarioyequipo.js"></script>
