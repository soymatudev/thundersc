...
<head>
  ...
  <title>Thunder</title>
  $globalImport
  <link rel="stylesheet" href="./RevisarVtaSco.css">
...
<body>
    ...
    <div class="container-user" >
        ...
        <span class="title-modu">Revisar ventas Scorpion</span>
        </div> 
  ...
  <div class="container-scroller">
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <div class="box-form bordes_redondeados shadow select-area" id="select-area">
          ...
          <div id="div-formato">
            <p class="label-c-g">Formato:</p>
            <select class="select col-md-2" tabindex="-1" aria-hidden="true" id="select-formato">
  ...
  <script src="./RevisarVtaSco.js"></script>
</body>
