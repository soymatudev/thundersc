      ...
      <div class="main-panel">
        <div class="content-wrapper" style="padding-top: 0;">
          ...
          <div class="row">
            ...
            <div style="padding: 0;" class="col-md-12 grid-margin stretch-card">
              <div class="card" style="border: 0;">
                <div class="card-body">
                  <div class="grid ag-theme-quartz-dark" id="container-tablaOne">
                    <div style="height: 50vh; background-image: url(../template/assets/images/nube3.avif);">
                      <h1 class="card-title" style="position:relative; left: 51%; top: 50%; transform:translate(-50%, -50%); font-size: 5em;">
                        Thunder
                      </h1>
                    </div>  
                  </div>
