...
<body>
    ...
    <div class="container-user" >
        ...
        <span class="title-modu">Sensores Maizoro</span>
        </div> 
  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="tab-wrapper">
        <ul class="tab-menu">
            <li id="tab0">Molinos</li>
            <li id="tab1">Silos</li>
        </ul>
      </div>

        <div class="card" id="server" style="border: none;">
          <div class="grid ag-theme-balham" id="grid" style="height: 85vh;">a</div>
        </div>

        <div class="card"  id="map" style="border: none;">
          <div class="grid ag-theme-balham" id="canva-map" style="height: 85vh;">b</div>
        </div>
