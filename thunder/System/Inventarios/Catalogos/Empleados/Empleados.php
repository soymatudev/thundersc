...
<body class="sidebar-icon-only">
    ...
    <div class="container-user" >
        ...
        <span class="title-modu">Catalogo de Empleados</span>
        </div> 
        ...
        <div class="card d-flex" style="flex-direction: row; border: none;">
          ...
          <div class="col-3">
            <div id="div-descri">
              ...
              <input type="text" maxlength="40" class="form_input bordes_redondeados input-area" name="descri" id="descri" placeholder=""/>
            </div>
          </div>
