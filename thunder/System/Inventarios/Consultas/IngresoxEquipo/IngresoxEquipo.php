...
<head>
  ...
  <title>Thunder</title>
  $globalImport
  <link rel="stylesheet" href="./IngresoxEquipo.css">
...
<body>
    ...
    <div class="container-user" >
        ...
        <span class="title-modu">Ingreso x Equipos</span>
        </div> 
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <div class="box-form bordes_redondeados shadow select-area" id="select-area">
          ...
          <div id="div-serie">
            ...
            <input type="text" maxlength="30" class="form_input bordes_redondeados input-area" name="serie" id="serie" />
          </div>

          <div id="div-codinv">
            <p class="label-c-g">Codigo de Inventario:</p>
            <input type="text" maxlength="30" class="form_input bordes_redondeados input-area" name="codinv" id="codinv" />
          </div>
          ...
          <div id="div-status">
            <p class="label-c-g">Activo:</p>
            <div class="d-flex" style="align-items: center; gap: .5rem;">
              <span class="span-indicator" for="btnone">S</span>
              <input type="radio" class="btnradio" name="btnstatus" id="checkactive" checked>
              <span class="span-indicator" for="btntwo">N</span>
              <input type="radio" class="btnradio" name="btnstatus" id="checkinactive" >
            </div>
          </div>
  ...
  <script src="./IngresoxEquipo.js"></script>
</body>
