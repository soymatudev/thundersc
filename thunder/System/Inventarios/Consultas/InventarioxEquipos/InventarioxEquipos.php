...
<head>
  ...
  <title>Thunder</title>
  $globalImport
  <link rel="stylesheet" href="./InventarioxEquipos.css">
...
<body>
    ...
    <div class="container-user" >
        ...
        <span class="title-modu">Inventario x Equipos</span>
        </div> 
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <div class="box-form bordes_redondeados shadow select-area" id="select-area">
        ...
        <div class="container-c-g">
          ...
          <div id="div-almacenes">
            <p class="label-c-g">Almacenes:</p>
          </div>
          ...
          <div id="div-empleados">
            <p class="label-c-g">Responsable:</p>
          </div>
  ...
  <script src="./InventarioxEquipos.js"></script>
</body>
