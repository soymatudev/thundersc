            ...
            <div class="card-body px-5 py-5">
              ...
              <form method="POST" action="./admin.php">
                <div class="form-group">
                  ...
                  <input name="user" type="text" class="form-control p_input" id="input-username" onkeydown="if(event.keyCode==13) document.getElementById('input-password').focus()">
                </div>
                <div class="form-group">
                  <label>Constrasena *</label>
                  <input name="pass" type="password" class="form-control p_input" id="input-password" onkeydown="if(event.keyCode==13) document.getElementById('btn-login').focus()">
                </div>

                <div class="text-center">
                  <input id="btn-login" type="submit" class="btn btn-primary btn-block enter-btn" value="Enviar">
                </div>
