  ...
  <div class="container-scroller">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
        <a class="sidebar-brand brand-logo" href="admin.php">Thunder</a>
      </div>
      <ul class="nav">
        ...
        <li class="nav-item menu-items">
          ...
          <div class="collapse" id="MenuMolinoSilo">
            <ul class="nav flex-column sub-menu">
              ...
              <li class="nav-item">
                <a class="nav-link" data-url="./Modulos/Modulos.php" id="Generar Modulos" onclick="addTab('Generar Modulos')">Generar Modulos</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-url="./Usuarios/Usuarios.php" id="Generar Usuarios" onclick="addTab('Generar Usuarios')">Generar Usuarios</a>
              </li>
            </ul>
          </div>
        </li>
...
if (isset($_POST['user']) && isset($_POST['pass']) && $_POST['user'] === 'thunPotter' && $_POST['pass'] === 'Potthunder') {
  echo $home;
} else if (isset($_POST['user']) && isset($_POST['pass']) && $_POST['user'] === '' && $_POST['pass'] === '') {
  echo "<script>alert('No se ha ingresado usuario y contraseña');</script>"; 
} else if (isset($_POST['user']) && isset($_POST['pass']) && $_POST['user'] != 'thunPotter' && $_POST['pass'] != 'Potthuder') {
  echo $NotPer;
} 